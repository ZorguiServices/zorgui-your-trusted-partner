        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-10">
          ...
          <div className="text-center space-y-4">
            ...
            <div className="flex items-center justify-center gap-3 text-primary-foreground/80">
              ...
              <a href="mailto:zorguimohamedsalah@gmail.com" className="hover:text-gold transition text-sm">zorguimohamedsalah@gmail.com</a>
            </div>
            <div className="flex items-center justify-center gap-3 text-primary-foreground/80">
              <div className="w-10 h-10 rounded-xl bg-gold/10 flex items-center justify-center">
          ...
          <div className="text-center md:text-end">
            <iframe
              ...
              width="100%" height="180" style={{ border: 0, borderRadius: '1rem' }} allowFullScreen loading="lazy" title="Google Maps"
            />
          </div>
        </div>
